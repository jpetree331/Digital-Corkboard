-- Paste this ENTIRE file into Vercel's Neon Query editor and click Run once.
-- One SQL statement, compatible with prepared-query editors. Safe to repeat.
-- Creates this app's tables; does not delete existing data.
DO $corkboard$
BEGIN
  PERFORM pg_advisory_xact_lock(hashtext('digital-corkboard-schema'));
